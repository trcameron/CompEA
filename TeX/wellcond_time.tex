...
\addplot+[thin, solid, mark=none] table [x=degree, y=ea_time, col sep=comma]{data_files/wellcond_rand_test.dat};
\addlegendentry{Ehrlich-Aberth, slope = {\pgfmathprintnumber[precision=2]{\fslopea}}}
\addplot+[thin, densely dotted, mark=none] table [x=degree, y=ea_quad_time, col sep=comma]{data_files/wellcond_rand_test.dat};
\addlegendentry{Ehrlich-Aberth-Quad, slope = {\pgfmathprintnumber[precision=2]{\fqslopea}}}
\addplot+[thin, dashdotted, mark=none] table [x=degree, y=ea_comp_time, col sep=comma]{data_files/wellcond_rand_test.dat};
...
\addplot+[thin, solid, mark=none] table [x=degree, y=ea_time, col sep=comma]{data_files/wellcond_nat_test.dat};
\addlegendentry{Ehrlich-Aberth, slope = {\pgfmathprintnumber[precision=2]{\fslopeb}}}
\addplot+[thin, densely dotted, mark=none] table [x=degree, y=ea_quad_time, col sep=comma]{data_files/wellcond_nat_test.dat};
\addlegendentry{Ehrlich-Aberth-Quad, slope = {\pgfmathprintnumber[precision=2]{\fqslopeb}}}
\addplot+[thin, dashdotted, mark=none] table [x=degree, y=ea_comp_time, col sep=comma]{data_files/wellcond_nat_test.dat};
